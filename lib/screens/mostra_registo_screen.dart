...
import '../widgets/formulario_registo_nao_editavel.dart';
import 'dashboard_screen.dart';
import 'novo_registo_screen.dart';

class MostraRegistoScreen extends StatelessWidget {
  const MostraRegistoScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      home: _MostraRegistoScreen(),
    );
  }
}

class _MostraRegistoScreen extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    final registarM = RegistarModel.getInstance();
    ...
    return Scaffold(
      ...
      body: const Padding(
        ...
        child: FormularioRegistoPreenchidoNaoEditavel(),
      ),
